      ...
      <Stack spacing={3}>
        <Card variant="outlined">
          <CardContent>
            <Stack direction="row" spacing={4} flexWrap="wrap" useFlexGap>
              ...
              <Metric label="Net to circuit" value={formatCurrencyFromCents(summary.netCents)} />
            </Stack>
          </CardContent>
        </Card>
        ...
        {registrations.length === 0 ? (
          <EmptyState
            ...
            description="Registrations appear here once drivers sign up for your sessions and coaching."
          />
        ) : (
          <Stack spacing={1.5}>
