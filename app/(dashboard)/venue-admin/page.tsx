...
export default async function VenueAdminPage() {
  ...
  return (
    <PageContainer>
      <PageHeader
        title="Venue Admin"
        subtitle="Manage circuit profiles, staff, schedules, requests, content, and team relationships."
        actions={
      ...
      {organizations.length === 0 ? (
        <EmptyState
          ...
          description="Venue Admin is for circuit and venue operators who run facilities: publish a branded public profile, manage staff, and schedule track time across your surfaces. Facilities your team or league books for games and practices are handled under Venues instead."
          action={
