export const metadata = {
  title: 'Getting Started Guides - Spartan Documentation',
  description: 'Quick start guides for Spartan team management.',
};

This quick-start guide helps a team manager launch an Spartan workspace and publish the first event.
