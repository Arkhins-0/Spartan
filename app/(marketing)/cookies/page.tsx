...
export const metadata = generatePageMetadata({
  title: 'Cookie Policy',
  description: 'Learn how Spartan uses cookies and similar technologies. Privacy-friendly analytics and essential cookies only.',
  path: '/cookies',
          ...
          <Box sx={{ maxWidth: PROSE_WIDTH }}>
            ...
            <Stack spacing={5}>
              ...
              <LegalSection
                ...
                covers="The table below is the current factual inventory of cookie categories Spartan uses."
              >
                <TableContainer sx={{ mt: 2, bgcolor: 'background.paper' }}>
                  <Table size="small" aria-label="Cookie categories used by Spartan">
                    <TableHead>
                      <TableRow>
              ...
              <LegalSection
                id="contact"
                title="Contact Us"
                covers="Cookie questions can be sent to tech@ctrsports.in."
              />
            </Stack>
