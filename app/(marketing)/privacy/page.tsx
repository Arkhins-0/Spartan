...
export const metadata = generatePageMetadata({
  ...
  description: 'Learn how Spartan handles personal data and keeps your information safe. Your data ownership and privacy are our priorities.',
  path: '/privacy',
          ...
          <Box sx={{ maxWidth: PROSE_WIDTH }}>
            ...
            <Stack spacing={5}>
              <LegalSection
                ...
                covers="Will describe the categories of data Spartan collects: account details (name, email, password), roster information entered by team admins (including player contact details, emergency contacts, and dates of birth), event and RSVP activity, payment records processed by Stripe, and technical/log data."
              />
              ...
              <LegalSection
                ...
                covers="Will describe how Spartan handles children's data: rosters may include players under 13, the platform records a date of birth and requires a parental-consent attestation before storing an under-13 player's information, and parents/guardians can request review or deletion of a child's data."
              >
              ...
              <LegalSection
                id="contact"
                title="Contact Us"
                covers="Privacy questions can be sent to tech@ctrsports.in."
              >
