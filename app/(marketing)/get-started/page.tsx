...
export const metadata = generatePageMetadata({
  title: 'Get Started',
  description: 'Start managing your race team or championship with Spartan in minutes. Quick setup guide and onboarding to get your paddock organised.',
  path: '/get-started',
...
const steps = [
  ...
  },
  {
    ...
    description:
      'Create your first race team by providing a name, discipline, and basic information. This takes less than a minute.',
    details: ['Choose a team name', 'Select your discipline', 'Add team details', 'Set up your preferences'],
  },
  {
    label: 'Invite Your Drivers and Crew',
    description:
      'Add drivers and crew to your entry list by sending email invitations. They can accept and create their own accounts.',
    details: [
      'Add driver and crew email addresses',
      'Send invitations automatically',
      'Track invitation status',
      'Drivers join via email link',
    ],
  },
  {
    label: 'Schedule Your First Race Weekend',
    description:
      'Create a round with practice, qualifying, and race sessions, plus circuit and paddock details. Your team will be notified automatically.',
    details: [
      'Choose the session type (Practice, Qualifying, or Race)',
      'Set date and time',
  ...
  },
  {
    label: 'Track Entries',
    description:
      'Team members receive email notifications and can confirm with Going, Not Going, or Maybe. See the grid at a glance.',
    details: [
      'Drivers confirm their entries',
      'View grid status',
      'Send reminders',
      ...
      <Box component="section" sx={{ bgcolor: 'background.default', py: { xs: 6, md: 8 } }}>
        <Container maxWidth="lg">
          ...
          <Typography variant="marketingBody" component="p" color="text.secondary" sx={{ maxWidth: PROSE_WIDTH }}>
            Your team or championship can be up and running in minutes.
          </Typography>
      ...
      >
        <Container maxWidth="lg">
          ...
          <Typography variant="body1" color="text.secondary" sx={{ mb: 3 }}>
            Sign up and begin managing your race team in minutes.
          </Typography>
          <LinkButton href="/signup" variant="contained" size="large">
            Sign Up Now
          </LinkButton>
