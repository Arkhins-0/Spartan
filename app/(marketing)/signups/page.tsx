...
export const metadata: Metadata = {
  ...
  description: "Upcoming signup events from local circuits, championships, and teams.",
};
  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        subtitle={
          events.length === 0
            ? "Track days, test sessions, marshal training and race weekends from local circuits, championships and teams"
