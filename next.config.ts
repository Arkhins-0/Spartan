...
const nextConfig: NextConfig = {
  ...
  // The public venue directory moved from /rinks to /circuits when Spartan
  // became motorsport-only; keep old links and search results working.
  async redirects() {
    return [
      {
        source: "/rinks",
