...
describe("venue relationship components", () => {
  ...
  it("accepts invitation responses through the Server Action", async () => {
    ...
    renderWithTheme(<VenueRelationshipInvitation relationshipId="rel-1" venueName="North Circuit" relationshipType="PREFERRED" />);

    expect(screen.getByText("North Circuit invited you to become a PREFERRED circuit.")).toBeInTheDocument();
