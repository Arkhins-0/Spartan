...
describe('MarketingFooter', () => {
  describe('Brand Section', () => {
    it('renders logo with correct props', () => {
      ...
      // No showText: the logo artwork carries the wordmark itself.
      expect(logo).not.toHaveTextContent('Spartan');
    });

    it('renders the brand logo', () => {
      renderWithTheme(<MarketingFooter />);
      // The brand name lives in the logo artwork, not a sibling text node.
  ...
  describe('Bottom Footer', () => {
    it('renders copyright with current year', () => {
      ...
      expect(screen.getByText(new RegExp(`© ${currentYear} Spartan`))).toBeInTheDocument();
    });
