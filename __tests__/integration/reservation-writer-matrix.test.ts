...
beforeEach(() => {
  ...
  mockPrisma.venueSurface.update.mockResolvedValue({ id: SURFACE_ID, venueId: VENUE_ID });
  ...
  mockPrisma.surfaceTimeRequest.findUnique.mockResolvedValue(null);
  mockPrisma.surfaceTimeRequest.findMany.mockResolvedValue([]);
