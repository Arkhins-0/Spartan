...
describe("deduplicateCalendarItems", () => {
  it("uses venue-block metadata but preserves the participant Event RSVP href in either input order", () => {
    const aliases = [
