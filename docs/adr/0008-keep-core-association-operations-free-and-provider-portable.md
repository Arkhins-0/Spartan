...
affects:
  ...
  - type: path
    pattern: "lib/storage/**"
    note: Media remains optional and cannot gate core operations (seam per ADR-0010).
  - type: path
    pattern: "lib/actions/**"
...
Spartan is intended to be a free, fully open-source service for volunteer-run
...
forks. It governs the Spartan project's core product and architecture.
...
- Easier: pitch Spartan to nonprofit associations; preserve user trust;
