...
/**
 * Schedule-first dashboard widget: events across all the viewer's teams for
 * the next 14 days. Async RSC — fetches its own data; wrap in
      ...
      {items.length === 0 ? (
        ...
        <List disablePadding sx={{ py: 0.5 }}>
          {items.map((item) => (
            ...
            >
              {item.eventType === "GAME" ? (
                <FlagIcon sx={{ color: "text.secondary", fontSize: 20, flexShrink: 0 }} />
              ) : (
