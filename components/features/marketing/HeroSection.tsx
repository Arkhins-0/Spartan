    ...
    >
      <Container maxWidth="md">
        <Stack spacing={4} alignItems="center" sx={{ textAlign: 'center' }}>
          ...
          >
            The free, open-source championship management platform built for race organisers,
            teams, and marshals. Replace chaotic spreadsheets and group chats with one organised
            paddock for entry lists, race weekends, session timetables, and communication.
          </Typography>
          ...
          >
            Built by racers, for racers. Open-source and community-driven—because running a
            championship should be simple, transparent, and free.
          </Typography>
        </Stack>
      </Container>
    </Box>
