...
const steps = [
  ...
  },
  {
    icon: GroupAddIcon,
    step: '2',
    title: 'Set Up Your Team or Championship',
    description: 'Add your team or championship details and invite drivers, crew, and marshals via email.',
  },
  {
    icon: RocketLaunchIcon,
    step: '3',
    title: 'Start Managing',
    description: 'Schedule race weekends, track entries and volunteers, and stay organised all season long.',
  },
];
    ...
    >
      <Container maxWidth="lg">
        <Box sx={{ textAlign: 'center', mb: 6 }}>
          ...
          >
            From signup to scheduling your first round—it&apos;s that simple. No complicated setup,
