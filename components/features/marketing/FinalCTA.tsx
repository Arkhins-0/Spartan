    ...
    >
      <Container maxWidth="md">
        <Stack spacing={3} alignItems="center" sx={{ textAlign: 'center' }}>
          ...
          >
            Join race organisers and team managers who&apos;ve ditched the spreadsheets and endless
            group chats. Get organised in minutes, stay organised all championship.
          </Typography>
