...
const testimonials = [
  {
    quote:
      'Spartan is built around the way volunteer coaches actually work: quick roster updates, fast RSVPs, and one place to check before practice.',
      ...
      <Container maxWidth="lg">
        <Box sx={{ textAlign: 'center', mb: 6 }}>
          ...
          >
            ...
            markers for coaches, managers, and clubs evaluating Spartan.
          </Typography>
        </Box>
