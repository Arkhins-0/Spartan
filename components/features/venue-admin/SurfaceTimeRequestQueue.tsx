...
export function SurfaceTimeRequestQueue({
  organizationId,
  venueId,
  venueName,
  venueTimeZone,
  ...
  async function changeRequestStatus(
    request: RequestSummary,
    action: typeof cancelSurfaceTimeRequest | typeof expireSurfaceTimeRequest,
  ) {
    setActionError(null);
  ...
  return (
    <Stack spacing={2}>
      ...
      {requests.length === 0 ? (
        <Typography color="text.secondary">No track time requests yet.</Typography>
              ...
              <Stack spacing={1.5}>
                ...
                <Stack direction="row" spacing={1} flexWrap="wrap" useFlexGap>
                  ...
                  <Button
                    sx={{ minHeight: 44 }}
                    color="error"
                    onClick={() => void changeRequestStatus(request, cancelSurfaceTimeRequest)}
                  >
                    Cancel
                  </Button>
                  <Button
                    ...
                    color="error"
                    variant="outlined"
                    onClick={() => void changeRequestStatus(request, expireSurfaceTimeRequest)}
                  >
                    Expire
                  </Button>
                </Stack>
                ...
                {request.status !== "SUBMITTED" ? (
                  <Stack direction={{ xs: "column", sm: "row" }} spacing={1} alignItems={{ sm: "center" }}>
                    ...
                    <Button
                      ...
                      onClick={() => {
                        setActionError(null);
                        void annotateSurfaceTimeRequest({
                          organizationId,
                          venueId,
                          requestId: request.id,
