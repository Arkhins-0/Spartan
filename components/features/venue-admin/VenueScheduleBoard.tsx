...
/** "OPEN_TRACK_DAY" -> "Open track day" for enum selects and conflict lines. */
...
export function VenueScheduleBoard({
  ...
  // so viewers in other zones see rows filed under the venue's wall-clock day
...
function BlockDialogBody({
  ...
  const [activityType, setActivityType] = useState<ActivityType>(
    (block?.activityType as ActivityType) ?? "OPEN_TRACK_DAY"
  );
