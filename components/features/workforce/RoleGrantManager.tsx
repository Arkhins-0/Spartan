...
const ROLE_GUIDANCE: Record<AssociationRole, string> = {
  ...
  SCHEDULER:
    "Race rounds, results, and their timetables within the scope you choose. Ice requests, reservations, games, and practices still follow league admin membership.",
