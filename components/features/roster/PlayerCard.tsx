...
type PlayerCardProps = {
  ...
  isAdmin: boolean;
  teamId: string;
  /** Motorsport teams show car number/class instead of jersey/position. */
  sport?: Sport;
  onEdit: () => void;
};
        ...
        <CardContent sx={{ flex: 1 }}>
          ...
          >
            <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
              {(isMotorsport ? player.carNumber : player.jerseyNumber) != null && (
                <Chip
                  label={`#${isMotorsport ? player.carNumber : player.jerseyNumber}`}
                  size="small"
                  color="primary"
                  variant="outlined"
              ...
              {(isMotorsport ? player.racingClass : player.position) && (
                <Chip
                  label={isMotorsport ? player.racingClass : player.position}
                  size="small"
                  variant="outlined"
                  sx={{ fontSize: "0.75rem" }}
                />
