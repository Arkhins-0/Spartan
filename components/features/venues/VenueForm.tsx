...
export default function VenueForm({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const payload = {
      ...formData,
      surfaceType: formData.surfaceType as "CIRCUIT" | "TRACK" | "PADDOCK" | "ROOM" | "OTHER",
  ...
  return (
    ...
    >
      ...
      <TextField
        ...
        placeholder="e.g., Madras International Circuit"
      ...
      <Box sx={{ display: "flex", gap: 2 }}>
        <FormControl fullWidth error={!!fieldErrors.surfaceType}>
          ...
          >
            ...
            <MenuItem value="PADDOCK">Paddock</MenuItem>
