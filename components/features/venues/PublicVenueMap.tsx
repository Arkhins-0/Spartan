...
/**
 * Public facility map for the circuit profile (FR-017). Renders the saved
...
export function PublicVenueMap({ layout, surfaces, venueName }: PublicVenueMapProps) {
  ...
  return (
    <Card component="section" aria-labelledby="facility-map-heading">
      <CardHeader
        title="Facility map"
        subheader="Schematic — not to scale"
        slotProps={{ title: { id: "facility-map-heading", component: "h2" } }}
      />
      <CardContent>
        <VenueLayoutCanvas
          layout={layout}
