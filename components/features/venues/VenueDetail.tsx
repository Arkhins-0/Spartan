...
export default function VenueDetail({ venue, canEdit, upcomingEvents = [] }: VenueDetailProps) {
  ...
  const subtitle = [
    surfaceTypeLabels[venue.surfaceType as SurfaceType] || venue.surfaceType,
          ...
          <CardHeader
            ...
            action={
              <Stack direction="row" spacing={1}>
                <Chip label={surfaceTypeLabels[venue.surfaceType as SurfaceType] || venue.surfaceType} size="small" />
