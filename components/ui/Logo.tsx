...
const LOGO_ALT_TEXT = 'Spartan Logo';
...
interface LogoProps {
  ...
  priority?: boolean;
  /**
   * Whether to show the "Spartan" text next to the logo
   */
  showText?: boolean;
  /**
...
/**
 * Logo component for Spartan branding
 *
 * Can display just the logo icon or include the "Spartan" wordmark.
