...
This document outlines the security measures implemented in the Spartan application.
...
For security issues or questions, email **[tech@ctrsports.in](mailto:tech@ctrsports.in)**.
Do not post security issues in public repositories or open a public GitHub issue.
