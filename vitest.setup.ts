...
// Mock ResizeObserver for MUI autosize and drag/drop components.
// Some libraries instantiate it with `new ResizeObserver(...)`, so this must be
// constructible instead of an arrow-function mock implementation.
...
process.env.EMAIL_FROM = 'test@spartan.test';
