...
export const addPlayerSchema = z.object({
  ...
  usahMemberId: z
    ...
    .nullable()
    .optional(),
  // Motorsport roster fields. Only surfaced for MOTORSPORT teams in the UI,
  // but always accepted here so the schema stays sport-agnostic (as
  // usahMemberId already is).
