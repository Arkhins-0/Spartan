...
**Structure Decision**: Standard Spartan layout — Server Components fetch in `app/(dashboard)/seasons/*`, mutations in `lib/actions/*`, pure logic in `lib/utils/*` for unit testability, feature components under `components/features/seasons/`.
